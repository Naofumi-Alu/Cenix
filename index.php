<!--Header-->
<?php include ('partialsIndex/header.php'); ?>


<body>
<!-- Navigation-->
<?php include ('partialsIndex/navigation.php'); ?>
			...
			<div id="rev_slider_1_1" class="rev_slider fullwidthabanner" style="display:none;max-height:600px;height:600px;">
				<ul>
					<li data-transition="random" data-slotamount="7" data-masterspeed="300" data-saveperformance="off">
						<!-- MAIN IMAGE -->
						<img src="images/Slider6.jpeg" alt="portfolio_img6" data-bgposition="left center" data-bgfit="cover" data-bgrepeat="no-repeat">
						<!-- LAYERS -->
						<!-- LAYER NR. 1 -->
			...
			<div class="amaze">
				<div class="container">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="amaze-item">
								<img src="images/Soluciones/tics370x250.jpg" alt="">
								<h4>TIC´s</h4>
						...
						<div class="col-md-4">
							<div class="amaze-item">
								<img src="images/Soluciones/Edificiosinteligentes370x250.jpeg" alt="">
						...
						<div class="col-md-4">
							<div class="amaze-item">
								<img src="images/Soluciones/Movilidad370x250.jpg" alt="">
								<h4>Movilidad</h4>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="amaze-item">
								<img src="images/Soluciones/Seguridadvial370x250.jpg" alt="">
						...
						<div class="col-md-4">
							<div class="amaze-item">
								<img src="images/Soluciones/software370x250.jpg" alt="">
								<h4>Software</h4>
						...
						<div class="col-md-4">
							<div class="amaze-item">
								<img src="images/Soluciones/IoT370x250.jpg" alt="">
								<h4>IoT</h4>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="amaze-item">
								<img src="images/Soluciones/Energia370x250.jpg" alt="">
								<h4>Energía</h4>
							...
							<div class="filters demo1">
								...
								<div class="clearfix">
									<ul class="filter-container home-filter clearfix">
										...
										<li class="class2">
											<div class="overlay">
												<img src="upload/portfolio/port4-2.jpg" alt="" />
												 <a href="#"><div class="mask">
													<div class="bottom-post">
														<h2>Servicios</h2>
										...
										<li class="class3">
											<div class="overlay">
												<img src="upload/portfolio/port4-3.jpg" alt="" />
												 <a href="#"><div class="mask">
													<div class="bottom-post">
										...
										<li class="class4">
											<div class="overlay">
												<img src="upload/portfolio/port4-4.jpg" alt="" />
												 <a href="#"><div class="mask">
													<div class="bottom-post">
														<h2>iR&D</h2>
										...
										<li class="class1">
											<div class="overlay">
												<img src="upload/portfolio/port4-8.jpg" alt="" />
												 <a href="#"><div class="mask">
													<div class="bottom-post">
														<h2>Ingenieria</h2>
										...
										<li class="class2">
											<div class="overlay">
												<img src="upload/portfolio/port4-5.jpg" alt="" />
												 <a href="#"><div class="mask">
													<div class="bottom-post">
														<h2>Consultorías</h2>
					...
					<div class="filters demo1">
						<div class="filter clearfix">
							<ul>
								...
								<li><a href="#" data-filter=".class1">Infrastructura</a></li>
								<li><a href="#" data-filter=".class2">Sofware</a></li>
						...
						<div class="clearfix">
							<ul class="filter-container home-filter clearfix">
								<li class="class1">
									<div class="overlay">
									    <img src="images/Proyectos/cctv.jpg" id="responsive-image" alt="" />
	    							 	<a href="#"><div class="mask">
									        <div class="bottom-post">
									        	<h2>Acueducto de Bogotá</h2>
									            <p>Instalación y desarrollo</p>
									        </div>
									    </div></a>
									</div>
								</li>
								...
								<li class="class2">
									<div class="overlay">
									    <img src="images/Logos/LOGO CYGNUS MODIFICADO.jpg" alt="" />
	    							 	<a href="#"><div class="mask">
									        <div class="bottom-post">
									        	<h2>Concesion Costera</h2>
									            <p>Cygnus sistema de administración vial</p>
									        </div>
									    </div></a>
									</div>
								</li>
								...
								<li class="class2">
									<div class="overlay">
									    <img src="images/banner/scada.png" alt="" />
	    							 	<a href="#"><div class="mask">
									        <div class="bottom-post">
									        	<h2>Acueducto de Bogotá</h2>
									            <p>Sistema Scada soporte y mantenimiento</p>
									        </div>
									    </div></a>
									</div>
								</li>
...
<?php include('partialsIndex/footer.php'); ?>
